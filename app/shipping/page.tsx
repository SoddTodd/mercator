        ...
        <div className="space-y-8 leading-relaxed text-sm md:text-base">
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Orders are fulfilled by Printful and shipped to supported US, EU, and UK addresses.</li>
              ...
              <li>If your parcel is delayed, lost, or damaged, contact us at [support email] with your order number.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Bestellungen werden über Printful produziert und an unterstützte Adressen in den USA, der EU und dem UK versendet.</li>
              ...
              <li>Bei Verzögerung, Verlust oder Transportschaden kontaktiere uns unter [Support-E-Mail] mit deiner Bestellnummer.</li>
            </ul>
          </section>
        </div>
